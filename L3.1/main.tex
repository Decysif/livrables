...
and Section~\ref{sec:creusot} presents the design choice for the memory model of
...
theorem proving tools. It is exemplified by the Iris~\cite{iris17} library
...
Isabelle/Simpl \todo{Claude: Citation schirmer} provides an infrastructure for reasoning about imperative
...
there exists the Stainless tool~\cite{chassot24ijcar}.

\todo{À revoir Gospel/Cameller + stainless: Claude}
